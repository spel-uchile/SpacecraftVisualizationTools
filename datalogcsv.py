...
class DataHandler(object):
    ...
    def create_variable(self):
        ...
        self.q_t_i2b = np.array(self.datalog[['q_t_i2b(3)[-]', 'q_t_i2b(0)[-]', 'q_t_i2b(1)[-]', 'q_t_i2b(2)[-]']].values)
        self.nadir_t_b = np.array(self.datalog[['tar_t_b(X)[Nm]', 'tar_t_b(Y)[Nm]', 'tar_t_b(Z)[Nm]']].values)
        self.control_torque = np.array(self.datalog[['Control_torque_b(X)[Nm]', 'Control_torque_b(Y)[Nm]', 'Control_torque_b(Z)[Nm]']])
